...
class LinearAnalysis:
    def __init__(self, bestX,targetY,fit):
        self.bestX = "" #depends on how you define your dataset and what you expect this value to be 
        self.targetY = "" #assume we're looking for a column name, so try strings, integer = 0 or -1, list = [], dictionary = {}, () aren't a datatype 
        self.fit = ""
...
class LogisticAnalysis: #code from lecture to be updated!!! 
    def __init__(self,):
        self.bestX = ""
        self.targetY = ""
        self.fit = ""
